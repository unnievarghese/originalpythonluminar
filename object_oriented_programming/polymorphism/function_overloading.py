...
m=maths()
print(m.add(1,2))   #this one works because it has two arg and add function with two parameter works because it is
                    #recently implemented
print(m.add(1))     #this one wont work becuase it has only 1 arg and add function with 1 parameter
